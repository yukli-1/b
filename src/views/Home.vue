      ...
      <div class="container">
        <div class="content-layout">
          ...
          <div class="articles-section">
            ...
            <!-- 加载更多 -->
            <div v-if="hasMoreArticles && !blogStore.isLoading" class="load-more">
              <button @click="loadMore" class="btn btn-primary" :disabled="isLoadingMore">
          ...
          <aside class="sidebar">
            ...
            <h3 class="profile-name">计算机学生</h3>
            <p class="profile-bio">热爱编程学习，专注前端技术</p>
...
const displayArticles = computed(() => {
  ...
  return articles.slice(0, displayedCount.value)
})

const hasMoreArticles = computed(() => {
  return displayArticles.value.length < blogStore.articles.length
})
...
.hero::before {
  ...
  right: 0;
  bottom: 0;
  background: url('data:image/svg+xml,<svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g fill="%233b82f6" fill-opacity="0.1"><path d="M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z"/></g></g></svg>') repeat;
  opacity: 0.15;
...
.hero::after {
  ...
  width: 200%;
  height: 200%;
  background: radial-gradient(circle, rgba(59, 130, 246, 0.15) 0%, rgba(37, 99, 235, 0.05) 40%, transparent 70%);
...
.hero-avatar {
  ...
  box-shadow: 0 20px 40px rgba(37, 99, 235, 0.3), 0 0 60px rgba(59, 130, 246, 0.2);
